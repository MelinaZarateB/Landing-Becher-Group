    ...
    <section className="container-about">
      <div className="grid-about" id="about">
        <div className={`card-grid ${show ? 'animate' : ''}`} ref={elementRef}>
          ...
          <p>
          Somos un grupo empresarial integrado por un equipo de profesionales comprometidos en crear soluciones a medida para nuestros clientes.
          </p>
        </div>
        <div className={`card-grid ${show ? 'animate' : ''}`} ref={elementRef}>
          <img src={imgPC} alt="" />
        ...
        <div className={`card-grid ${show ? 'animate' : ''}`} ref={elementRef}>
          ...
          <p>
          Utilizamos la metodología Scrum y aplicamos un conjunto de mejores prácticas para maximizar la eficiencia en cada proyecto y empresa.
          </p>
        </div>
        <div className={`card-grid ${show ? 'animate' : ''}`} ref={elementRef}>
